...
CREATE TABLE IF NOT EXISTS COMPLIANCE_FINDING (
    ...
    CONSTRAINT CK_FIND_TYPE CHECK (FINDING_TYPE IN
        ('MISSING_MANDATORY_TAG', 'INVALID_VALUE', 'UNKNOWN_REFERENCE_VALUE',
         'CONDITIONAL_RULE_BREACH', 'ILLEGAL_OVERRIDE', 'POLICY_DRIFT',
...
CREATE TABLE IF NOT EXISTS ROW_ACCESS_ENTITLEMENT (
    ...
    DIMENSION     STRING NOT NULL,   -- BUSINESS_UNIT | DOMAIN | DATA_RESIDENCY
...
COMMENT = 'Reconciliation between Snowflake auto-classification and the accountable enterprise PII decision.';
...
CREATE TABLE IF NOT EXISTS COMPLIANCE_SCORE_HISTORY (
    ...
    SCOPE_TYPE       STRING NOT NULL,   -- ACCOUNT | BUSINESS_UNIT | DOMAIN | DATABASE
