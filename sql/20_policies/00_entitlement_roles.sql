...
CREATE ROLE IF NOT EXISTS RESTRICTED_DATA_READER
    COMMENT = 'Sees RESTRICTED classified data in clear.';
CREATE ROLE IF NOT EXISTS HIGHLY_RESTRICTED_DATA_READER
    COMMENT = 'Sees HIGHLY_RESTRICTED classified data in clear. Break-glass; alerted on use.';
...
GRANT ROLE HIGHLY_RESTRICTED_DATA_READER TO ROLE ACCOUNTADMIN;
